...
export const GetAccountDocument = gql`
  ...
  account(publicKey: $publicKey) {
    ...
    `;
export const GetMerklePathDocument = gql`
...
export const GetPermissionsDocument = gql`
  ...
  account(publicKey: $publicKey) {
    ...
    `;
export const GetRecentPaymentsDocument = gql`
  ...
  bestChain(maxLength: $maxLength) {
    ...
    `;
export const GetRecentZkAppCommandsDocument = gql`
...
export const GetBlockByHeightDocument = gql`
  ...
  block(height: $height) {
    ...
    `;
export const GetUserCommandsByHeightDocument = gql`
  ...
  block(height: $height) {
    ...
    `;
export const GetZkAppCommandsByHeightDocument = gql`
  ...
  block(height: $height) {
    ...
    `;
export const GetSnarkJobsByHeightDocument = gql`
...
export const GetBlockByHashDocument = gql`
  ...
  block(stateHash: $stateHash) {
    ...
    `;
export const GetUserCommandsByBlockHashDocument = gql`
  ...
  block(stateHash: $stateHash) {
    ...
    `;
export const GetZkAppCommandsByBlockHashDocument = gql`
  ...
  block(stateHash: $stateHash) {
    ...
    `;
export const GetSnarkJobsByBlockHashDocument = gql`
  ...
  block(stateHash: $stateHash) {
    ...
    `;
export const GetGenesisBlockDocument = gql`
  ...
  genesisBlock {
    ...
    `;
export const GetPooledUserCommandsDocument = gql`
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    GetAccount(variables: GetAccountQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetAccountQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetAccountQuery>(GetAccountDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetAccount', 'query', variables);
    },
    GetMerklePath(variables: GetMerklePathQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetMerklePathQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetMerklePathQuery>(GetMerklePathDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetMerklePath', 'query', variables);
    },
    GetPermissions(variables: GetPermissionsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetPermissionsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetPermissionsQuery>(GetPermissionsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetPermissions', 'query', variables);
    },
    GetRecentPayments(variables: GetRecentPaymentsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetRecentPaymentsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetRecentPaymentsQuery>(GetRecentPaymentsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetRecentPayments', 'query', variables);
    },
    GetRecentZkAppCommands(variables: GetRecentZkAppCommandsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetRecentZkAppCommandsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetRecentZkAppCommandsQuery>(GetRecentZkAppCommandsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetRecentZkAppCommands', 'query', variables);
    },
    GetBlockByHeight(variables: GetBlockByHeightQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetBlockByHeightQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetBlockByHeightQuery>(GetBlockByHeightDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetBlockByHeight', 'query', variables);
    },
    GetUserCommandsByHeight(variables: GetUserCommandsByHeightQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetUserCommandsByHeightQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetUserCommandsByHeightQuery>(GetUserCommandsByHeightDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetUserCommandsByHeight', 'query', variables);
    },
    GetZkAppCommandsByHeight(variables: GetZkAppCommandsByHeightQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetZkAppCommandsByHeightQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetZkAppCommandsByHeightQuery>(GetZkAppCommandsByHeightDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetZkAppCommandsByHeight', 'query', variables);
    },
    GetSnarkJobsByHeight(variables: GetSnarkJobsByHeightQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetSnarkJobsByHeightQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetSnarkJobsByHeightQuery>(GetSnarkJobsByHeightDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetSnarkJobsByHeight', 'query', variables);
    },
    GetBlockByHash(variables: GetBlockByHashQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetBlockByHashQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetBlockByHashQuery>(GetBlockByHashDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetBlockByHash', 'query', variables);
    },
    GetUserCommandsByBlockHash(variables: GetUserCommandsByBlockHashQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetUserCommandsByBlockHashQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetUserCommandsByBlockHashQuery>(GetUserCommandsByBlockHashDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetUserCommandsByBlockHash', 'query', variables);
    },
    GetZkAppCommandsByBlockHash(variables: GetZkAppCommandsByBlockHashQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetZkAppCommandsByBlockHashQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetZkAppCommandsByBlockHashQuery>(GetZkAppCommandsByBlockHashDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetZkAppCommandsByBlockHash', 'query', variables);
    },
    GetSnarkJobsByBlockHash(variables: GetSnarkJobsByBlockHashQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetSnarkJobsByBlockHashQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetSnarkJobsByBlockHashQuery>(GetSnarkJobsByBlockHashDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetSnarkJobsByBlockHash', 'query', variables);
    },
    GetGenesisBlock(variables?: GetGenesisBlockQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetGenesisBlockQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetGenesisBlockQuery>(GetGenesisBlockDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetGenesisBlock', 'query', variables);
    },
